            ...
            try
            {
                ...
                var result = new
                {
                    ...
                    Zaposleni = odsek.Zaposleni.Select(z => new
                    {
                        ...
                        z.PunoIme,
                        z.Email,
                        Pozicija = z.Pozicija?.Naziv ?? "Nepoznato",
                        PozicijaDisplay = z.PozicijaDisplay
                    })
                };
            ...
            try
            {
                ...
                var zaposleni = await _context.Zaposleni
                    ...
                    .Select(z => new
                    {
                        ...
                        z.PunoIme,
                        z.Email,
                        Pozicija = z.Pozicija != null ? z.Pozicija.Naziv : "Nepoznato",
                        PozicijaDisplay = z.PozicijaDisplay,
                        z.DatumZaposlenja
                    })
                    .OrderBy(z => z.PunoIme)
